...
class Track:
    ...
    def __repr__(self):
        return f"{self.name} by {self.artists[0].name} released on {self.label.name} | sample [{self.sample}]"
...
class Artist:
    def __init__(self, data):
        ...
        self.image = data['image']['dynamic_uri'] if 'image' in data else data['artist_image_uri']
    ...
    def __repr__(self):
        return f"{self.name} [{self.slug}/{self.id}] : {self.image}"    
...
class Label:
    def __init__(self, data):
        ...
        self.image = data['image']['dynamic_uri'] if 'image' in data else data['label_image_uri']
